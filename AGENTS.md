...
- **AI docs**: Keep AGENTS.md files updated for AI context (this file structure)
...
See [ARCHITECTURE.md](ARCHITECTURE.md) for the full design principles. The key rules:
