...
**JSON Mode Supported Providers**: OpenAI, Anthropic, Google, Groq, OpenAI-Compatible (varies), Mistral, DeepSeek, xAI, DashScope, MiniMax, OpenRouter, Azure, Perplexity  
**Schema Mode Supported Providers (v1)**: OpenAI, Azure, OpenAI-Compatible, Google (Gemini), Vertex AI, Anthropic, OpenRouter (model-dependent), Groq, Mistral, Ollama, xAI (model-dependent), Perplexity (model-dependent)
