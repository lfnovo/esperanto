...
- **[llm/](llm/AGENTS.md)**: Language model providers (chat completion, text generation)
- **[embedding/](embedding/AGENTS.md)**: Embedding providers (text-to-vector conversion)
- **[reranker/](reranker/AGENTS.md)**: Reranker providers (relevance-based document ranking)
- **[stt/](stt/AGENTS.md)**: Speech-to-text providers (audio transcription)
- **[tts/](tts/AGENTS.md)**: Text-to-speech providers (audio generation)
...
9. Create AGENTS.md for the new directory
