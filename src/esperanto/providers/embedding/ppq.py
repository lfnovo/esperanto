"""PayPerQ (PPQ) embedding provider implementation."""

import os
from typing import Any, Dict, Optional

from .openai_compatible import OpenAICompatibleEmbeddingModel

DEFAULT_BASE_URL = "https://api.ppq.ai/v1"


class PPQEmbeddingModel(OpenAICompatibleEmbeddingModel):
    """PayPerQ embedding provider.

    PayPerQ (https://ppq.ai) is a pay-as-you-go gateway that exposes
    OpenAI-compatible embedding models at ``https://api.ppq.ai/v1/embeddings``.
